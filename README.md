...
این پروژه با هدف پیاده‌سازی یک Backend واقعی برای مدیریت فروش بلیط هواپیما و تمرین طراحی API، Authentication، Database و مدیریت تراکنش‌های مالی توسعه داده شده است.
